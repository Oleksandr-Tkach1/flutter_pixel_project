...
class OrderItemDashboard extends StatefulWidget {
  final Order order;
  final int index;
  final OrdersDashboardState state;

  OrderItemDashboard({Key? key, required this.order, required this.index, required this.state}) : super(key: key);

  @override
  State<OrderItemDashboard> createState() => _OrderItemDashboardState();
}

class _OrderItemDashboardState extends State<OrderItemDashboard> {
  String _getImageUrl(OrdersDashboardState state, int index) {
