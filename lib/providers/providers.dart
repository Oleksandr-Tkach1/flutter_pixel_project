...
import '../utils/check_internet_connection/bloc/check_internet_connection_bloc.dart';
import '../utils/check_internet_connection/bloc/check_internet_connection_event.dart';
...
getProviders(RestClient client, AuthRestClient authClient) {
  return [
    ...
    BlocProvider(create: (context) => CheckInternetConnectionBloc()..add(ConnectionObserve())),
  ];
}